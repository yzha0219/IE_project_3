$(document).ready(function(){
    ...
    $("#airway").click(function(){
        colorSet();
        document.getElementById('airway').style.color='black';
    ...
    $("#breathing").click(function(){
        colorSet();
        document.getElementById('breathing').style.color='black';
    ...
    $("#rescue").click(function(){
        colorSet();
        document.getElementById('rescue').style.color='black';
    ...
    $("#aed").click(function(){
        colorSet();
        document.getElementById('aed').style.color='black';
...
function colorSet(){
    ...
    document.getElementById('rescue').style.color='#d33e04';
